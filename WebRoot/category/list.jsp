	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/category/add.jsp";
			}
		</script>
	</HEAD>
	<body>
								...
								<s:iterator var="c" value="cList" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px"><!--  -->
												<a href="${pageContext.request.contextPath}/category_editUI.action?cid=<s:property value="#c.cid"/>">
													<img src="${pageContext.request.contextPath}/images/i_editUI.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
