...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/categorysecond_edit.action" method="post" enctype="multipart/form-data">
					...
					<td class="ta_01" bgColor="#ffffff">
						<select name="category.cid">
						  <s:iterator value="cList" var="c">
						   <option value="${c.cid}" <s:if test="model.category.cid==#c.cid">selected</s:if>>${c.cname }</option>
						  </s:iterator> 
						</select>
					</td>
				</tr>
